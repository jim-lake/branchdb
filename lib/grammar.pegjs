...
create_table_only
  = !( create_start ( INDEX / TRIGGER / VIEW / VIRTUAL / DATABASE ) ) c:( create_table )
  { return c; }

create_index_only
  = !( create_start ( TABLE / TRIGGER / VIEW / VIRTUAL / DATABASE ) ) c:( create_index )
  { return c; }

create_trigger_only
  = !( create_start ( TABLE / INDEX / VIEW / VIRTUAL / DATABASE ) ) c:( create_trigger )
  { return c; }

create_view_only
  = !( create_start ( TABLE / INDEX / TRIGGER / VIRTUAL / DATABASE ) ) c:( create_view )
  { return c; }

create_virtual_only
  = !( create_start ( TABLE / INDEX / TRIGGER / VIEW / DATABASE ) ) c:( create_virtual )
  { return c; }

create_database_only
  = !( create_start ( TABLE / INDEX / TRIGGER / VIEW / VIRTUAL ) ) c:( create_database )
  { return c; }
...
drop_types "DROP Type"
  = t:( TABLE / INDEX / TRIGGER / VIEW / DATABASE ) o
  { return keyNode(t); }
